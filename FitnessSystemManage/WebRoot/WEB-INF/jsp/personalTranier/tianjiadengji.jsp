	...
	<div class="div">
    	...
    	<table>
        	<tr>
                ...
                <td><input type="text" size="50px" name="personalLever"/></td>
            </tr>
            <tr > 
                <td class="left">课程单价:</td>
                <td><input type="text" size="50px" name="personalPrice" placeholder="(元)"/></td></tr>
        	<tr>                                                            
        </table>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/personalTranierjs/tianjiadengji.js"></script>
</html>
