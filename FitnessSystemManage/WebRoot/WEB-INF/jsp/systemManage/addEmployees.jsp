...
<body>
	<div class="container">
		<div class="content">
		  <form action="addEmployees" method="post" id="formEmployees" >
		      	<table class="kv-table" style="margin-left:8%">
					<tbody>
						<tr>
							<td class="kv-label">工号:</td>
							<td class="kv-content"><input type="text" name="employeesId" size="80" value="${maxEmpId+1}"  readonly="readonly" required="required" >
						...
						<tr>
							...
							<td class="kv-content"><input type="text" name="name" size="55"   value="${emp.name}"  required="required" >
                            	<select style="width:160px;background:#f5f5f5" name="sex">
                                	<option value="男" <c:if test="'男'==${emp.sex}"> selected="selected"</c:if>>男</option>
                                    <option value="女" <c:if test="'女'==${emp.sex}"> selected="selected"</c:if>>女</option>
                                </select>
                            </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="kv-content">
							     <select style="width:275px;background:#f5f5f5" id="province" name="address1">
                                </select>
                                <select style="width:275px;background:#f5f5f5" id="city" name="address2">
                                </select>
                            </td>
						</tr>
						<tr>
							<td class="kv-label"></td>
							<td class="kv-content"><input type="text" name="address3" size="80" value="${address3}"></td>
						</tr> 
						<tr>
						...
						<tr>
							<td class="kv-label"></td>
							<td class="kv-content">
                              <input class="input" type="submit" value="提交" style="margin-left:150px; margin-right:10px; width:100px; height:30px;">
                             <input class="input" type="button" id="qingkong" value="清空"  style=" width:100px; height:30px;">
                            </td>
						</tr>                                                                          
					</tbody>
				</table>
...
<script type="text/javascript">
		...
		$("#qingkong").click(function(){
			window.location.href="goAddEmployees";
		});
		//初始化会员信息
	 	$(function() {
			var sum=$("#sum").val();
